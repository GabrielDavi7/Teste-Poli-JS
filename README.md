Este projeto para a disciplina de Paradigmas de Programação é uma demonstração prática do paradigma da Programação Orientada a Objetos (POO) em JavaScript.
